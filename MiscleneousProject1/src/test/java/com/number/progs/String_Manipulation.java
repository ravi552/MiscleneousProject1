...
public class String_Manipulation {
	...
	public static void main(String[] args) {
		...
		String str = "The rains have started heres sele";
		String newStr ="is this what i think it is";
		//int len=str.indexOf('h', str.indexOf('h')+1);
		int first =str.indexOf('s');
		int second=str.indexOf('s', str.indexOf('s')+1);
		int third = str.indexOf('s', second+1);
